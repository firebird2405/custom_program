' launch_memo.vbs
' Opens memo.html as a Microsoft Edge app window (no browser UI, no console flash).
...
cmd = """" & edgePath & """" _
    & " --app=file:///D:/custom_program/memo.html" _
    & " --user-data-dir=""D:\custom_program\.edge\memo""" _
    & " --window-size=780,780" _
    & " --window-position=1110,70" _
    & " --no-first-run" _
