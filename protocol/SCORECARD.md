# 채점표 — 캘린더 + 포스트잇 월 (v1 rev.5 — 발주 #2 확장: A19~A41)
...
---
채점기 SHA256 기대값: 32f23f0e367b74bcdcc8f655b22eed6aa6a8aea392b45a9781d5e9b3a5135b3e
(기록: 2026-08-13, rev.5 채점기 확장(A19~A41 스펙 23항목) 동결 — 이 줄 위의 기대값 줄은 64자리 hex만 허용됨. Node lib/hash.js와 INDEPENDENT_HASH.txt PowerShell 한 줄 이중 계산 일치 확인)
